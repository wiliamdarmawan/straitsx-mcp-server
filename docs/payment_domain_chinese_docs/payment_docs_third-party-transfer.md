...
# https://docs.straitsx.com/docs/third-party-转账
...
# Third Party 转账 (客户 Profile)

This integration type is intended for partners who use StraitsX API to collect
付款 and make payouts on behalf of their users. We will require information
on your users as per regulations before we are able to process transactions on
behalf of them.

Some examples of partners under this model are 付款 service providers. If
you are unsure whether you fall under this category, [contact
us](doc:support).
...
Learn about third party 转账's flow in detail.
