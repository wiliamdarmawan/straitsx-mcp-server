...
# https://docs.straitsx.com/docs/purpose-code-for-FAST-payouts
...
For any SGD payouts via the FAST network, you can pass in an optional purpose
code to identify the purpose of the 交易. We support passing in the
following list of purpose codes:
...
[Swap API](/docs/swap-api)[Webhooks / Callbacks](/docs/webhooks-callbacks)
