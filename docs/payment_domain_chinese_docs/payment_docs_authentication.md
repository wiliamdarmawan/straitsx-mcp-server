...
# https://docs.straitsx.com/docs/身份认证
...
The StraitsX API uses API keys to authenticate requests. You can view and
manage your API keys and secrets on the StraitsX Business Dashboard.
...
身份认证 to the API is performed via HTTP Basic Auth. Provide your API
key as the basic auth username value and apply the secret key as the password.

API requests must be made over HTTPS. Calls made over plain HTTP will fail.
API requests without 身份认证 will also fail.

请求头 参数 Name| Instructions  
---|---  
X-XFERS-APP-API-KEY| You can retrieve this from your StraitsX Business
Dashboard  
X-XFERS-APP-SECRET-KEY|  _Deprecated_  
  
 __Updated about 1 month ago

* * *

[交易 Safety](/docs/交易-safety)[API Upgrades and Backward
Compatibility](/docs/backward-compatibility)
