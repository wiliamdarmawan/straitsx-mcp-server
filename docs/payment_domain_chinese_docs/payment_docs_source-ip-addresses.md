...
# https://docs.straitsx.com/docs/source-ip-addresses
...
Webhooks will be sent from these IP Addresses. You will need to whitelist
these IP Addresses to receive webhooks for both 生产环境 and 沙盒环境
environments.
...
[Purpose Code for FAST Payouts](/docs/purpose-code-for-FAST-payouts)[Securing
Your 回调](/docs/securing-your-回调)
